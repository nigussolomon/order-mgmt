  ...
  const upperNavData = [
    {
      ...
      icon: IconMist,
      links: [
        { label: "Sales Order", link: "/orders/sales-order" },
        { label: "Purchase Order", link: "/orders/purchase-order" },
      ],
    },
    {
      label: "Quotations",
    ...
    },
    {
      ...
      icon: IconUsersGroup,
      links: [
        { label: "Order Managers", link: "/personal/order-managers" },
        {
          label: "Sales Representatives",
          link: "/personal/sales-representatives",
        },
